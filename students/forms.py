...
class TeacherSignupForm(UserCreationForm):
    username = forms.CharField(label='', widget=forms.TextInput(
        attrs={'class': 'flex-grow h-8 mt-4 px-2 rounded border border-gray-400', 'placeholder': 'Username'}))
    email = forms.EmailField(required=True, label='', widget=forms.TextInput(
        attrs={'class': 'flex-grow mt-4 h-8 px-2 rounded border border-gray-400', 'placeholder': 'E-mail'}))
    password1 = forms.CharField(label='', widget=forms.PasswordInput(
        attrs={'class': 'flex-grow h-8 mt-4  px-2 rounded border border-gray-400', 'placeholder': 'Password'}))
    password2 = forms.CharField(label='', widget=forms.PasswordInput(
        attrs={'class': 'flex-grow h-8 mt-4 px-2 rounded border border-gray-400',
...
class StudentSignupForm(UserCreationForm):
    username = forms.CharField(label='', widget=forms.TextInput(
        attrs={'class': 'flex-grow h-8  mt-4  px-2 rounded border border-gray-400', 'placeholder': 'Username'}))
    email = forms.EmailField(required=True, label='', widget=forms.TextInput(
        attrs={'class': 'flex-grow h-8  mt-4  px-2 rounded border border-gray-400', 'placeholder': 'E-mail'}))
    password1 = forms.CharField(label='', widget=forms.PasswordInput(
        attrs={'class': 'flex-grow h-8 mt-4  px-2 rounded border border-gray-400', 'placeholder': 'Password'}))
    password2 = forms.CharField(label='', widget=forms.PasswordInput(
        attrs={'class': 'flex-grow h-8 mt-4  px-2 rounded border border-gray-400',
...
class ContactForm(forms.Form):
    ...
    contact_email = forms.EmailField(label="Your email address", required=True,
                                     widget=forms.TextInput(attrs={'class': 'form-control'}))
    form_content = forms.CharField(label="Your message", required=True,
