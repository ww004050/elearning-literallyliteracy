...
urlpatterns = [
    ...
    url(r'^course/(?P<pk>\d+)/$', cache_page(60 * 15)(students.StudentCourseDetailView.as_view()),
        name='student_course_detail'),
    url(r'^course/(?P<pk>\d+)/(?P<module_id>\d+)/$', cache_page(60 * 15)(students.StudentCourseDetailView.as_view()),
    ...
    url(r'^quiz/(?P<quiz_pk>\d+)/question/(?P<question_pk>\d+)/$', teachers.question_change,
        name='teacher_change_question'),
    url(r'^quiz/(?P<quiz_pk>\d+)/question/(?P<question_pk>\d+)/delete/$', teachers.QuestionDeleteView.as_view(),
